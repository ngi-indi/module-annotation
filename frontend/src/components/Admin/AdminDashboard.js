...
const AdminDashboard=()=>{
    ...
    const UsersData = async () => {
        try {
        const data = await axios.get('http://reviewbackend/api/users?populate=*', {
            headers: {
...
//<div className={stockClassName}>{rowData.quantity}</div>;
    ...
    const Save =async () => {
        ...
        const response = await axios.post(`http://reviewbackend/api/users-permissions/user/change-role`,{
            "data" :{
